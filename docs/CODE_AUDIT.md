...
- Livraison de `json-schema-validator` dans une tranche verticale complète, avec parseur JSON strict, Draft 7, 2019-09 et 2020-12, formats Ajv activables, références internes sans chargement réseau, diagnostic par chemins d’instance et de schéma, proposition corrigée limitée aux transformations prudentes puis revalidée, plafonds sur profondeur, nœuds, erreurs, motifs et sorties, import UTF-8, Worker annulable, partage sans données, interface mobile accessible et 57 tests ciblés.
