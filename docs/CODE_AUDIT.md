...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,81 kB brut, 166,24 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,08 MB brut, 303,23 kB transféré) |
...
| Couverture | aucun seuil | 56,55 % statements, 47,34 % branches, 53,20 % fonctions, 60,56 % lignes |
...
Dernière mesure Playwright locale en configuration CI sur l’accueil mobile : LCP 2 176 ms, CLS 0,0043, `DOMContentLoaded` 287,2 ms et interaction thème 62,2 ms. Ce sont des garde-fous de laboratoire, variables selon la machine, pas des Core Web Vitals terrain.
