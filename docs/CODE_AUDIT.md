...
| Tests unitaires | suite non compilable | 132 fichiers, 400 tests verts sous Vitest |
| Couverture | aucun seuil | 48,41 % statements, 35,18 % branches, 48,37 % fonctions, 51,86 % lignes |
