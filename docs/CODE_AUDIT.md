...
| Tests unitaires | suite non compilable | 117 fichiers, 297 tests verts sous Vitest |
...
- Livraison de `software-application-schema-builder` dans une tranche verticale complète, avec génération JSON-LD locale, contrôles Schema.org et Google, notes réelles facultatives, prix décimal exact, sortie HTML sûre, diagnostics reliés aux champs, export, accessibilité et 27 tests ciblés.
