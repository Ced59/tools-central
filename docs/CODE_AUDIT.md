...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,81 kB brut, 166,16 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,07 MB brut, 301,21 kB transféré) |
...
| Couverture | aucun seuil | 56,22 % statements, 46,69 % branches, 52,94 % fonctions, 60,20 % lignes |
