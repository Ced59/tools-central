...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,81 kB brut, 166,12 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,08 MB brut, 303,09 kB transféré) |
...
| Couverture | aucun seuil | 56,45 % statements, 47,10 % branches, 53,15 % fonctions, 60,45 % lignes |
...
Dernière mesure Playwright locale en configuration CI sur l’accueil mobile : LCP 1 568 ms, CLS 0, `DOMContentLoaded` 167,6 ms et interaction thème 47,9 ms. Ce sont des garde-fous de laboratoire, variables selon la machine, pas des Core Web Vitals terrain.
