...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,81 kB brut, 166,19 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,08 MB brut, 303,93 kB transféré) |
...
| Couverture | aucun seuil | 56,75 % statements, 47,63 % branches, 53,35 % fonctions, 60,80 % lignes |
...
Dernière mesure Playwright locale en configuration CI sur l’accueil mobile : LCP 2 328 ms, CLS 0,0043, `DOMContentLoaded` 334,5 ms et interaction thème 92,6 ms. Ce sont des garde-fous de laboratoire, variables selon la machine, pas des Core Web Vitals terrain.
