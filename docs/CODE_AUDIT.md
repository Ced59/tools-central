...
| Tests unitaires | suite non compilable | 139 fichiers, 495 tests verts sous Vitest |
| Couverture | aucun seuil | 51,24 % statements, 39,33 % branches, 50,59 % fonctions, 54,77 % lignes |
...
- Les Workers PDF.js restent paresseux : celui de l’inspecteur pèse 1,01 MB brut (287,01 kB transféré estimé) et ne charge son moteur de parsing qu’à l’usage ; mémoire et temps doivent rester surveillés sur de gros documents.
