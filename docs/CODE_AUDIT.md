...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,81 kB brut, 166,20 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,02 MB brut, 289,53 kB transféré) |
| Vulnérabilités npm | 58, dont 5 critiques | 0 |
| Tests unitaires | suite non compilable | 139 fichiers, 529 tests verts sous Vitest |
| Couverture | aucun seuil | 52,20 % statements, 40,81 % branches, 50,96 % fonctions, 55,83 % lignes |
...
Dernière mesure Playwright locale en configuration CI sur l’accueil mobile : LCP 568 ms, CLS 0,0043, `DOMContentLoaded` 487,2 ms et interaction thème 78,0 ms. Ce sont des garde-fous de laboratoire, variables selon la machine, pas des Core Web Vitals terrain.
