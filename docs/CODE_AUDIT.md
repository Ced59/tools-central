...
| Tests unitaires | suite non compilable | 138 fichiers, 445 tests verts sous Vitest |
| Couverture | aucun seuil | 49,91 % statements, 37,10 % branches, 49,56 % fonctions, 53,44 % lignes |
...
Dernière mesure Playwright locale sur l’accueil mobile : LCP 1 780 ms, CLS 0, `DOMContentLoaded` 392 ms et interaction thème 120,8 ms. Ce sont des garde-fous de laboratoire, variables selon la machine, pas des Core Web Vitals terrain.
