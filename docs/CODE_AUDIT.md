...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,82 kB brut, 166,17 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,07 MB brut, 300,94 kB transféré) |
...
| Couverture | aucun seuil | 56,11 % statements, 46,55 % branches, 52,92 % fonctions, 60,08 % lignes |
