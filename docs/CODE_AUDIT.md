...
- Durcissement complémentaire de `pdf-privacy-inspector` : résolution des longueurs indirectes par frontière de flux avant exclusion du contenu binaire, conservation des noms FileSpec propres à Unix, Mac et DOS, et budget agrégé des configurations et instances RichMedia partagées. Le total actualisé est de 133 tests ciblés.
