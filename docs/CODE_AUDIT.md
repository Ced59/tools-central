...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,81 kB brut, 166,16 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,07 MB brut, 300,27 kB transféré) |
...
| Couverture | aucun seuil | 55,96 % statements, 46,28 % branches, 52,80 % fonctions, 59,90 % lignes |
