...
| Tests unitaires | suite non compilable | 139 fichiers, 483 tests verts sous Vitest |
| Couverture | aucun seuil | 50,93 % statements, 38,95 % branches, 50,34 % fonctions, 54,46 % lignes |
...
- Les Workers PDF.js restent paresseux : celui de l’inspecteur pèse 976,08 kB brut (281,92 kB transféré estimé) et ne charge son moteur de parsing qu’à l’usage ; mémoire et temps doivent rester surveillés sur de gros documents.
