...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,82 kB brut, 166,18 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,07 MB brut, 300,38 kB transféré) |
...
| Couverture | aucun seuil | 56,03 % statements, 46,40 % branches, 52,82 % fonctions, 59,99 % lignes |
