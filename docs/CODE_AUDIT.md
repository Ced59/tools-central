...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,81 kB brut, 166,14 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,07 MB brut, 299,94 kB transféré) |
...
| Couverture | aucun seuil | 55,87 % statements, 46,19 % branches, 52,79 % fonctions, 59,79 % lignes |
