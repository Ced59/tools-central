...
| Bundle initial de production | 656,90 kB lors du premier build corrigé | 658,82 kB brut, 166,12 kB transféré estimé ; PDF.js et les moteurs documentaires restent dans des chunks lazy (Worker d’inspection PDF : 1,08 MB brut, 303,22 kB transféré) |
...
| Couverture | aucun seuil | 56,53 % statements, 47,23 % branches, 53,17 % fonctions, 60,53 % lignes |
...
Dernière mesure Playwright locale en configuration CI sur l’accueil mobile : LCP 2 060 ms, CLS 0,0043, `DOMContentLoaded` 175,4 ms et interaction thème 130,6 ms. Ce sont des garde-fous de laboratoire, variables selon la machine, pas des Core Web Vitals terrain.
