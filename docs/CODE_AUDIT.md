...
- Livraison de `software-application-schema-builder` dans une tranche verticale complète, avec génération JSON-LD locale, contrôles Schema.org et Google, notes réelles facultatives, prix décimal exact, sortie HTML sûre, export, accessibilité et 26 tests ciblés.
