...
export class CsvJsonConverterToolComponent {
  ...
  issueLabel(issue: CsvJsonIssue): string {
    const labels: Readonly<Record<CsvJsonIssueCode, string>> = {
      ...
      'csv-header-collision': $localize`:@@csv_json_issue_header_collision:Deux en-têtes deviennent identiques après la neutralisation des formules. Renommez l’une des colonnes.`,
