...
export class JsonSchemaValidatorToolComponent {
  ...
  issueLabel(issue: JsonSchemaIssue): string {
    const labels: Record<JsonSchemaIssue['code'], string> = {
      ...
      'validation-limit': $localize`:@@json_schema_issue_validation_limit:La combinaison du schéma et des données dépasse 50 000 opérations de validation estimées. Réduisez leur taille ou validez un fragment à la fois.`,
